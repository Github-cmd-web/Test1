...
var spawn_with_tag = "<span class='glyphicon glyphicon-thumbs-up'>Like: "+like+"</span></button><hr>";

row = name_with_tag + message_with_tag + like_button + spawn_with_tag;
...
function updateLike(message_id){
      ...
      var likes = document.getElementById(button_id).innerHTML.value;
